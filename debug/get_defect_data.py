...
def main():
    ...
    # defect_data = {
    # 'MD05240518384500162 REV.A 2024-08-13起蒼2': {'製令單號': 'MD052405150016', '品號': '28384 REV.A', '完工日期': '2024-08-13', '不良項目': '起蒼', '不良數': '2'},
...
def get_defect_data_from_web():
    ...
    search_month = str(input('輸入要查詢的月份(1, 2, 3, ...12) : '))
    ...
    select_month.select_by_value(search_month)
...
def weekly_work_excel_clean(defect_dict):
    ...
    working_num.rename(columns={'完工數量': '總生產數'}, inplace=True)
    return working_num
